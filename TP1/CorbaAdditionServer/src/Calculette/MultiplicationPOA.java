...
/**
* Calculette/MultiplicationPOA.java .
...
public abstract class MultiplicationPOA extends org.omg.PortableServer.Servant
 implements Calculette.MultiplicationOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("mult", new java.lang.Integer (0));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Calculette/Multiplication/mult
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
  ...
  private static String[] __ids = {
    "IDL:Calculette/Multiplication:1.0"};
